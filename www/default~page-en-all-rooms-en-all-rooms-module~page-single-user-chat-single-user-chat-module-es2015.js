...
/* harmony import */ var cordova_plugin_fcm_with_dependecy_updated_ionic_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! cordova-plugin-fcm-with-dependecy-updated/ionic/ngx */ "lOSq");
...
let EnAllRoomsPage = class EnAllRoomsPage {
    constructor(router, _connecter, alertCtrl, firestore, platform, _location, fcm) {
        this.router = router;
