(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["page-en-one-on-one-en-one-on-one-module"], {
    ...
    /***/
    function GGee(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EnOneOnOnePageModule", function () {
        return EnOneOnOnePageModule;
      });
      /* harmony import */
      ...
      var _en_one_on_one_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./en-one-on-one-routing.module */
      "IFRt");
      /* harmony import */


      var _en_one_on_one_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./en-one-on-one.page */
      "c8T2");

      var EnOneOnOnePageModule = function EnOneOnOnePageModule() {
        _classCallCheck(this, EnOneOnOnePageModule);
      };

      EnOneOnOnePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _en_one_on_one_routing_module__WEBPACK_IMPORTED_MODULE_5__["EnOneOnOnePageRoutingModule"]],
    ...
    /***/
    function IFRt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EnOneOnOnePageRoutingModule", function () {
        return EnOneOnOnePageRoutingModule;
      });
      /* harmony import */
      ...
      var _en_one_on_one_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./en-one-on-one.page */
      "c8T2");
      ...
      var EnOneOnOnePageRoutingModule = function EnOneOnOnePageRoutingModule() {
        _classCallCheck(this, EnOneOnOnePageRoutingModule);
      };

      EnOneOnOnePageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function ZZUz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function c8T2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EnOneOnOnePage", function () {
        return EnOneOnOnePage;
      });
      /* harmony import */
      ...
      var _raw_loader_en_one_on_one_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./en-one-on-one.page.html */
      "hFTK");
      /* harmony import */


      var _en_one_on_one_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./en-one-on-one.page.scss */
      "ZZUz");
      /* harmony import */
      ...
      var src_app_services_en_data_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/services/en-data.service */
      "Y4Ib");
      /* harmony import */


      var _attachment_upload_attachment_upload_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../attachment-upload/attachment-upload.page */
      "bzF1");

      var EnOneOnOnePage = /*#__PURE__*/function () {
        // @ViewChild('input', { read: ElementRef }) msgInput: ElementRef;
        function EnOneOnOnePage(route, chatService, router, alertCtrl, modalController, datepipe, popovercontroller) {
          var _this = this;

          _classCallCheck(this, EnOneOnOnePage);
          ...
          firebase__WEBPACK_IMPORTED_MODULE_7__["default"].firestore().collection("chats").doc(this.uid).collection(this.o_uid).orderBy("time").onSnapshot(function (snap) {
            _this.chats = [];
            snap.forEach(function (child) {
              _this.chats.push(child.data());
            }); // this.chat = this.chats;
          });
        }

        _createClass(EnOneOnOnePage, [{
          key: "ngOnInit",
          value: function ngOnInit() {// this.messages = this.chatService.getOneChatMessages()
          }
        }, {
          key: "sendMessage",
      ...
      EnOneOnOnePage.ctorParameters = function () {
        return [{
      ...
      EnOneOnOnePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    function hFTK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=page-en-one-on-one-en-one-on-one-module-es5.js.map