...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FileSizeFormatPipePipe", function() { return FileSizeFormatPipePipe; });
...
let FileSizeFormatPipePipe = class FileSizeFormatPipePipe {
    static forRoot() {
...
FileSizeFormatPipePipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let HeadingPipe = class HeadingPipe {
    transform(value, arg, type) {
        if (value) {
...
HeadingPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'heading'
    })
], HeadingPipe);
